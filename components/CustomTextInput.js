...
export const CustomTextInput = ({
  ...
  return (
     ...
     <View style={{flexDirection:labelStatus?"column":"row",alignItems:"center",marginTop:marginTop,borderRadius:10,  borderWidth:1,
...
{    labelStatus&&<Text style={{marginRight:"auto",marginLeft:20,marginTop:-12,backgroundColor:"white",fontSize:14,fontWeight:"bold"}}>{label}</Text>
}
     <TextInput
