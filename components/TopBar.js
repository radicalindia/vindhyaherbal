        ...
        <Modal
         ...
         <View
           ...
           <TouchableOpacity
            ...
            <TouchableOpacity onPress={()=>{navigate("ProfileDetail"); setModalVisible(false)}} style={[styles.adminbox]}>
              <View
                style={{
                  borderRadius: 80,
                  height: 80,
              ...
              <View>
                ...
                <Text style={[styles.adminname]}>{user?.user?.fullName||"Test USer"}</Text>
                <Text style={[styles.adminname,{opacity:.8}]}>{user?.user?.fullName||"+91988798798"}</Text>
